...
plot(friendsCount$FriendsCount, xlab='Friends', ylab='Number of friends', 
main='')
...
plot(friendsCount$FriendsCount, log='y', xlab='Followers', ylab='Number of Folowers', 
main='Dr. Nelson\'s Twitter Follower vs Number of Followers')
